			...
			<div class="box_sort2">
				...
				<div class="item line">
					...
					<select style="width: 200px;" name="searchType"> 
						...
						<option value="coup_name"	<?=( $pSearchType == 'coup_name'	)? "SELECTED": "" ?> >응시권명</option> 
...
$(document).ready(function () {
	...
	$("#btnWrite").on("click", function () {
		location.href = "/language/vchrsWrite.php";
	});

	$(".btnIssuedList").on("click", function () {
		location.href = "/language/vchrsIssuedList.php?coupCode="+$(this).attr("data-coupCode");
	});
